...
## [PCAD] ALDS1_8_C: Binary Search Tree III
...
## [PCAD] ALDS1_8_C: Binary Search Tree III (続き5)

解説の疑似コードを見る

この問題でgetSuccessorを呼ぶのは必ず子が２つあるときなので、
...
## [PCAD] ALDS1_8_C: Binary Search Tree III (続き6)
...
findやNodeクラスに普通に書けるし、Nodeクラスに書いたら
Treeクラスではself.root.find(key)みたいに呼び出せば済む
でもinsertやdeleteはTreeのrootを知ってる必要があるから
Nodeクラスには書けないし
特にinsertはNodeクラスに実装すると
